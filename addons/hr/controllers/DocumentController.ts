 ...
 */
export const downloadDocumentFile = async (req: any, res: any) => {
  try {
    const { id } = req.params;
 ...
 */
export const updateDocumentStatus = async (req: any, res: any) => {
  try {
    const { id } = req.params;
 ...
 */
export const getExpiringDocuments = async (req: any, res: any) => {
  try {
 ...
 */
export const getExpiredDocuments = async (req: any, res: any) => {
  try {
    const documents = await Document.findAll({
      where: {
        expiry_date: {
